...
public class DesignCharacterState implements IState {
    ...
    public DesignCharacterState(Framework framework, String name) {
        ...
        for (int i = 0; i < characterCount; i++) {
            ...
            try {
                source = ImageIO.read(this.getClass().getResource("/resources/images/Characters/Character" + String.valueOf(i) + ".png"));
            }
            ...
            if(keyboardstate[KeyEvent.VK_ENTER][1]) {
                switch(scroller2.getCountX()) {
                    case(1):
                        ...
                        try {
                            chosenImage = ImageIO.read(this.getClass().getResource("/resources/images/Characters/Character" + String.valueOf(characterChoice) + ".png"));
                        }
                        catch (IOException ex) {
                            Logger.getLogger(Framework.class.getName()).log(Level.SEVERE, null, ex);
                        }
                ...
                if (!keyboardstate[KeyEvent.VK_A][0] && !keyboardstate[KeyEvent.VK_D][0]) { // Handle the absence of scrolling
                    ...
                    if (keyboardstate[KeyEvent.VK_A][1]) { // Handle the A Key is down
                    ...
                    if (keyboardstate[KeyEvent.VK_D][1]) { // Handle the D Key is down
